...
//challenge 2
 ...
 console.log("¿Como te llamas bruh? ");
 console.log(prompt("¿Como te llamas, bruh?" , "pablito clavo un clavito"));
alert("Muuuucho gusto, bruh");
console.log("Muuuucho gusto, bruh");